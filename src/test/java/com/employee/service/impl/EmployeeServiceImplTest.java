...
public class EmployeeServiceImplTest {
    ...
    public void testGetEmployeeByName_Success() {
        ...
        List<Employee> asList = new ArrayList<>();
        asList.add(employee);
        when(employeeRepository.findByEmployeeName("John Doe")).thenReturn(asList);
    ...
    public void testUpdateEmployee_Success() {
        ...
        List<Employee> asList = new ArrayList<>();
        asList.add(existingEmployee);
        when(employeeRepository.findByEmailId("john.doe@example.com")).thenReturn(asList);
